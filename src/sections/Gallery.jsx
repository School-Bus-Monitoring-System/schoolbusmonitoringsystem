    ...
    <div className="flex flex-col lg:flex-row justify-center align-middle text-center">
      <div className="carousel w-11/12 lg:w-1/2 m-4 lg:m-2">
        <div id="slide1" className="carousel-item relative w-full">
          <img
            src="https://i0.wp.com/www.indcareer.com/news/wp-content/uploads/2022/07/Higher-Education-in-India-Challenges-and-Opportunities-Chitkara-University.jpg?fit=771%2C493&ssl=1"
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <img
            src="https://d1vwxdpzbgdqj.cloudfront.net/s3-public-images/institutions/Deakin.png"
            className="w-full rounded-3xl"
            alt="slide2"
          />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
        ...
        <div id="slide3" className="carousel-item relative w-full">
          <img
            src="https://images.collegedunia.com/public/college_data/images/appImage/1594119075Web2020Head60.jpg"
            className="w-full rounded-3xl"
            alt="slide3"
          />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
